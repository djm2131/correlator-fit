...
if not np.isnan(t_fit[0]):
  ...
  if meff[-1,0] >= t_fit[1]:
    ...
    exit(-1)
  if data_label:
    plt.errorbar(meff[0:idx_ti,0], meff[0:idx_ti,1], yerr=meff[0:idx_ti,2], marker='o', color='k', ls='none', label=data_label)
  else:
    plt.errorbar(meff[0:idx_ti,0], meff[0:idx_ti,1], yerr=meff[0:idx_ti,2], marker='o', color='k', ls='none')
  plt.errorbar(meff[idx_ti:idx_tf,0], meff[idx_ti:idx_tf,1], yerr=meff[idx_ti:idx_tf,2], marker='o', color='r', ls='none')
  plt.errorbar(meff[idx_tf:,0], meff[idx_tf:,1], yerr=meff[idx_tf:,2], marker='o', color='k', ls='none')
else:
  if data_label:
    plt.errorbar(meff[:,0], meff[:,1], yerr=meff[:,2], marker='o', color='k', ls='none', label=data_label)
  else:
    plt.errorbar(meff[:,0], meff[:,1], yerr=meff[:,2], marker='o', color='k', ls='none')
